'''
Copyright 2019 The Deepcode-AI DeepGPT Team
...
from deepgpt.pt.deepgpt_utils import get_grad_norm, CheckOverflow, get_weight_norm
import math
...
class FP16_Optimizer(object):
   ...
   For usage example please see, TODO:  DeepGPT V2 Tutorial
    """
    def __init__(self,
                 init_optimizer,
    ...
    def step_fused_adam(self, closure=None):
        ...
        if self.overflow:
            ...
            if self.verbose:
                print("[deepgpt] OVERFLOW! Skipping step. Attempted loss "
